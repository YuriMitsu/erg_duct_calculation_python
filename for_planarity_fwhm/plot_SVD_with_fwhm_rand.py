...
names_phi = [wna5_phi0360_wave8_phi, wna15_phi0360_wave8_phi, wna25_phi0360_wave8_phi, wna35_phi0360_wave8_phi, wna45_phi0360_wave8_phi, wna55_phi0360_wave8_phi, wna65_phi0360_wave8_phi, wna75_phi0360_wave8_phi]
...
# plt.tight_layout()
# plt.savefig('/Users/ampuku/Documents/duct/Fig/calcs/rand_wna575_phi0360_wave8')
...
names_phi = [wna5_phi090_wave8_phi, wna15_phi090_wave8_phi, wna25_phi090_wave8_phi, wna35_phi090_wave8_phi, wna45_phi090_wave8_phi, wna55_phi090_wave8_phi, wna65_phi090_wave8_phi, wna75_phi090_wave8_phi]
# for name in names_phi:
    # plt.plot(freq[(freq>200.) & (freq<1000.)], name.mean()[(freq>200.) & (freq<1000.)])
    # plt.plot(freq[(freq>200.) & (freq<1000.)], name.std()[(freq>200.) & (freq<1000.)])
    # plt.show()
...
names_theta = [wna5_phi090_wave8_theta, wna15_phi090_wave8_theta, wna25_phi090_wave8_theta, wna35_phi090_wave8_theta, wna45_phi090_wave8_theta, wna55_phi090_wave8_theta, wna65_phi090_wave8_theta, wna75_phi090_wave8_theta]
# for name in names_theta:
    # plt.plot(freq[(freq>200.) & (freq<1000.)], name.mean()[(freq>200.) & (freq<1000.)])
    # plt.plot(freq[(freq>200.) & (freq<1000.)], name.std()[(freq>200.) & (freq<1000.)])
    # plt.show()
...
names_pla = [wna5_phi090_wave8_pla, wna15_phi090_wave8_pla, wna25_phi090_wave8_pla, wna35_phi090_wave8_pla, wna45_phi090_wave8_pla, wna55_phi090_wave8_pla, wna65_phi090_wave8_pla, wna75_phi090_wave8_pla]
# for name in names_pla:
    # plt.plot(freq[(freq>200.) & (freq<1000.)], name.mean()[(freq>200.) & (freq<1000.)])
    # plt.plot(freq[(freq>200.) & (freq<1000.)], name.std()[(freq>200.) & (freq<1000.)])
    # plt.show()
...
# plt.tight_layout()
# plt.savefig('/Users/ampuku/Documents/duct/Fig/calcs/rand_wna575_phi090_wave8')
...
names_phi = [wna5_phi0_wave8_phi, wna15_phi0_wave8_phi, wna25_phi0_wave8_phi, wna35_phi0_wave8_phi, wna45_phi0_wave8_phi, wna55_phi0_wave8_phi, wna65_phi0_wave8_phi, wna75_phi0_wave8_phi]
# for name in names_phi:
    # plt.plot(freq[(freq>200.) & (freq<1000.)], name.mean()[(freq>200.) & (freq<1000.)])
    # plt.plot(freq[(freq>200.) & (freq<1000.)], name.std()[(freq>200.) & (freq<1000.)])
    # plt.show()
...
plt.tight_layout()
# plt.savefig('/Users/ampuku/Documents/duct/Fig/calcs/rand_wna575_phi0_wave8')
plt.savefig('/Users/ampuku/Documents/duct/Fig/calcs/rand_wna575_wave8')
