...
# %%
file_path = eventlist.csv
data = pd.read_csv('/Users/ampuku/Documents/duct/code/python/'+file_path)
...
# %%
data.to_csv('/Users/ampuku/Documents/duct/code/python/'+file_path, index=False)
